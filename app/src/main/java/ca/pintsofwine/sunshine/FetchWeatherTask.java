...
/**
 * Created by ross on 6/6/15.
 */
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {

    private static final String BASE_WEATHER_URL = "http://api.openweathermap.org/data/2.5/forecast/daily";
    ...
    protected void onPostExecute(String[] result) {
        if (result != null) {
            forecastFragment.updateWeatherData(result);
        }
    }
